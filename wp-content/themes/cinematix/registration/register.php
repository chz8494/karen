...
<div id="container">
	...
	<div class="page-title"><?php esc_html_e( 'Create an Account', 'cinematix' ); ?></div>
	...
	<div class="page" id="register-page">
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<div class="submit">
				...
				<?php } else { ?>
				<input type="submit" name="signup_submit" id="signup_submit" value="<?php esc_html_e( 'Complete Sign Up', 'buddypress' ); ?>" />
				<?php } ?>
			</div>
