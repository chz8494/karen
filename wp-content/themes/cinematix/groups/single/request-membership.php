...
<?php if ( !bp_group_has_requested_membership() ) : ?>
	<p><?php printf( esc_html__( "You are requesting to become a member of the group '%s'.", 'buddypress' ), bp_get_group_name( false ) ); ?></p>
	...
	<form action="<?php bp_group_form_action('request-membership'); ?>" method="post" name="request-membership-form" id="request-membership-form" class="standard-form">
		...
		<p><input type="submit" name="group-request-send" id="group-request-send" value="<?php esc_html_e( 'Send Request', 'buddypress' ); ?>" />
