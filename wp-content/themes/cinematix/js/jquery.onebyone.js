...
'use strict'; 	
    ...
    $.fn.oneByOne = function(options) {  
		...
		if(settings.showButton){
            ...
            $('.buttonCon a', buttonArea).on('click', function(event){        			  
		...
		if(settings.showArrow){
            ...
            var _next = $('.nextArrow', arrowButton).on('click', function(event) {
				nextBanner();
            });
            var _prev = $('.prevArrow', arrowButton).on('click', function(event) {
				prevBanner();
            });
