<tr id="topic-<?php bbp_topic_id(); ?>" <?php bbp_topic_class(); ?>>
	...
	<?php echo bbp_get_topic_author_link( array( 'size' => '45', 'type' => 'avatar' ) ); ?>
	...
	<td class="forum-topic-cell">
		...
		<?php esc_html_e( 'Started by', 'cinematix' ); ?> <?php printf( bbp_get_topic_author_link( array( 'type' => 'name' ) ) ); ?> <?php esc_html_e( 'on', 'cinematix' ); ?> <?php bbp_reply_post_date(); ?>
			...
			<?php if ( !bbp_is_single_forum() || ( bbp_get_topic_forum_id() != bbp_get_forum_id() ) ) : ?>
				...
				<?php
				printf( wp_kses( __( 'in: <a href="%1$s">%2$s</a>', 'bbpress' ), $allowed_html_array ), bbp_get_forum_permalink( bbp_get_topic_forum_id() ), bbp_get_forum_title( bbp_get_topic_forum_id() ) );
				?>
				</span>
	...
	<td class="forum-freshness-cell">
		...
		<?php do_action( 'bbp_theme_before_topic_freshness_link' ); ?>
				...
				<div class="last-poster-avatar"><?php bbp_author_link( array( 'post_id' => bbp_get_topic_last_active_id(), 'size' => 40, 'type' => 'avatar' ) ); ?></div>
					...
					<?php esc_html_e( 'Last post by ', 'cinematix' ); ?> <?php bbp_author_link( array( 'post_id' => bbp_get_topic_last_active_id(), 'type' => 'name' ) ); ?>
