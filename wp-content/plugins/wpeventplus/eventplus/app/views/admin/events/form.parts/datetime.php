<div class="postbox">
    <div class="inside">
        <div class="padding">
            ...
            <br>
            <span class="steptitle"><img class="stepimg" src="<?php echo $this->assetUrl('images/check-icon.png'); ?>"><?php _e('Choose Event\'s Time', 'evrplus_language'); ?></span>
            <div class="form-table">
                ...
                <p class="p1"><label><?php _e('Start Date', 'evrplus_language'); ?></label>
                    ...
                    <label><?php _e('Start Time', 'evrplus_language'); ?></label><label for="start_time"><?php
                ...
                <p class="p2"><label><?php _e('End Date', 'evrplus_language'); ?></label><label for="end_date"><?php echo EventPlus_Helpers_Funx::dateSelector("\"end", strtotime($end_date)); ?></label>
                    <label><?php _e('End Time', 'evrplus_language'); ?></label><label for="end_time"><?php
                ...
                <p class="p3"><label><?php _e('Do you want the event to be recurring?', 'evrplus_language'); ?></label><select id="recurring_choice" name="recurring_choice"><?php
                ...
                <div class="recurrence_options">
                    <p class="p3"><label><?php _e('Recurrence Period', 'evrplus_language'); ?>:</label><select name="recurring_period">
                            <option value=""<?php
                    ...
                    <p><label  class="tooltip" for="recurrence_frequency">
                            <?php _e('Repeat number of times', 'evrplus_language'); ?></label></p><p class="cs2" title="<?php _e('Enter the number of times you want the event to occur.', 'evrplus_language'); ?>"></p><br/>
                    <input  class="recurrence_frequency" name="recurrence_frequency" value="<?php echo $recurrence_frequency; ?>" type="number" min="0" max="100"></p>

                    <p><label  class="tooltip" for="recurrence_repeat">
