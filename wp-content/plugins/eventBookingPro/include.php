...
require_once dirname( __FILE__ ) . '/EbpAddOnManager.php';
...
require_once dirname( __FILE__ ) . '/EbpPayPal.php';
require_once dirname( __FILE__ ) . '/EbpShare.php';
require_once dirname( __FILE__ ) . '/EbpText.php';
require_once dirname( __FILE__ ) . '/EbpEventCard.php';
require_once dirname( __FILE__ ) . '/EbpEventCardExtended.php';
